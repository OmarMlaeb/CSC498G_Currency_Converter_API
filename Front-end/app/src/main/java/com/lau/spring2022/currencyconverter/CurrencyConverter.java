...
public class CurrencyConverter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://172.20.10.2/Currency_Converter_Server/get_rate.php"; // url of the local host api getting the rate
    ...
    public void convert(View view) {
        ...
        if (amount_value.equals("")) {
            ...
            String url2 = "http://172.20.10.2/Currency_Converter_Server/post_conversions.php?amount=" + parse_amount +
